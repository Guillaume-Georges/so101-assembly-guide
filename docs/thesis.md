...
already has. What they lack at the bench is, per step: _which_ of the 20-odd
printed parts, _which_ of the six servos (they differ by gear ratio and are
not interchangeable), in _which_ orientation, with _which_ screws, and _how
to know they got it right_ before the next step buries the mistake.
